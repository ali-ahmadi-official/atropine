(function () {
    ...
    const categoriesoptions = {
        ...
        title: {
            text: 'برچسب های داده های سفارشی',
            align: 'center',
            floating: true,
            style: {
                fontSize: '13px',
        ...
        subtitle: {
            text: 'نام های دسته بندی به عنوان برچسب های داده در داخل میله ها',
            align: 'center',
        },
        tooltip: {
            theme: 'dark',
    ...
    const patternedoptions = {
        ...
        title: {
            text: 'استراتژی فروش را مقایسه کنید',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
                color: '#8c9097'
    ...
    const imagefilloptions = {
        ...
        title: {
            text: 'مسیرهای پر شده توسط تصویر بریده شده',
            align: 'right',
            offsetY: 30,
            style: {
                fontSize: '13px',
