...
function ltrFn() {
    ...
    localStorage.setItem("vyzorltr", "true"); // ذخیره انتخاب LTR
    localStorage.removeItem("vyzorrtl");
    checkOptions();
}
...
function rtlFn() {
    ...
    localStorage.setItem("vyzorrtl", "true"); // ذخیره انتخاب RTL
    localStorage.removeItem("vyzorltr");
    checkOptions();
}

// اضافه‌شده برای تنظیم پیش‌فرض RTL
window.addEventListener("load", () => {
    if (!localStorage.vyzorltr && !localStorage.vyzorrtl) {
        rtlFn();
    }
});
