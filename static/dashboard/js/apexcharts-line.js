(function () {
    ...
    const dashedoptions = {
        ...
        xaxis: {
            categories: ['01 جلسه', '02 جلسه', '03 جلسه', '04 جلسه', '05 جلسه', '06 جلسه', '07 جلسه', '08 جلسه', '09 جلسه',
                '10 جلسه', '11 جلسه', '12 جلسه'
            ],
            labels: {
                show: true,
                style: {
