...
(function () {
    ...
    const option3 = {
        ...
        legend: {
            data: ['ایمیل', 'تبلیغات اتحادیه', 'تبلیغات ویدیویی', 'دایرکت', 'موتور جستجو'],
            textStyle: {
              color: '#777'
            }
        },
    ...
    const option5 = {
        ...
        legend: {
            data: ['مرحله شروع', 'وسط قدم', 'پایان مرحله'],
            textStyle: {
              color: '#777'
            }
        },
    ...
    const option9 = {
        ...
        xAxis: {
            ...
            data: ['مجموع', 'اجاره', 'برنامه', 'حمل', 'غذا', 'دیگر'],
            axisLine: {
                lineStyle: {
                    color: "#8c9097"
                }
    ...
    const option12 = {
        ...
        yAxis: {
            type: 'category',
            data: ['برزیل', 'اندونزی', 'ایران', 'هندوستان', 'چین', 'جهان'],
            axisLine: {
                lineStyle: {
                    color: "#8c9097"
                }
    ...
    const data = [
        [
            ...
            [26424, 75.7, 57110117, 'انگلستان', 1990],
            [37062, 75.4, 252847810, 'ایران', 1990]
        ],
        [
            ...
            [38225, 81.4, 64715810, 'انگلستان', 2015],
            [53354, 79.1, 321773631, 'ایران', 2015]
        ]
    ];
    const option17 = {
    ...
    const option22 = {
        ...
        legend: {
            data: ['نشان دادن', 'کلیک', 'بازدید', 'تحقیق', 'ترتیب'],
            textStyle: {
              color: '#777'
            }
        },
    ...
    function makeOption(type, symbol) {
        return {
            ...
            yAxis: {
                data: ['گوزن', 'کشتی', 'هواپیمای', 'قطار', 'ماشین'],
                inverse: true,
                axisLine: { show: false },
                axisTick: { show: false },
                axisLabel: {
